...
**Read and work through:** [Coordinates and affine maps](../notebooks/05_coordinates_and_affine_maps.ipynb) — Why adding one coordinate handles translation. Least squares remains optional. Use the relevant worked example during the existing seminar time; this sheet is its companion investigation, not a replacement for the explanation. [Reading map](../docs/notebook_route.md).
