...
**Read and work through:** [Linear transformations](../6_linear_transformations.ipynb) — From columns to the whole picture; the grid examples. Extend the idea to polynomials in the seminar. Use the relevant worked example during the existing seminar time; this sheet is its companion investigation, not a replacement for the explanation. [Reading map](../docs/notebook_route.md).
